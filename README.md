...
- 모바일 화면으로 다른 사람의 옷장을 살펴보며 내가 원하는 스타일의 패션을 찾아볼 수 있는 곳 
- 
- 
- 
...
- 우의명 : 회원가입, 로그인, 마이페이지, git관리(공통)
- 윤주연 : 상품 등록, 수정, 삭제, 상세페이지, Layout 등 공통 컴포넌트, 노션작성 채팅, git관리(공통)
- 이지원 : 댓글(대댓글), 검색, 프로필, 홈화면, figma, UI/UX, git관리(공통)
